<template>
  <v-app light>
    <v-app-bar class="px-lg-12 pt-lg-5 elevation-0 toolbarcustom">
      <v-toolbar-title>
        <v-img class="mt-2" max-width="110" src="/img/logo2.png"></v-img>
      </v-toolbar-title>
      <v-spacer></v-spacer>
          ...
          <div class="container" style="margin-top:190px;">
            <v-row>
              <v-col cols="12" xs="6" sm="6">
                ...
                <p style="text-align: justify !important;">TaskForce is {{lorem}}</p>
              </v-col>
        ...
        <v-container grid-list-xl>
          <v-layout row wrap justify-center class="my-12 text-center">
            <v-flex class="my-11">
              ...
              <v-btn class="mt-5 text-center">contact form</v-btn>
            </v-flex>
          </v-layout>
        </v-container>
      </section>-->
      ...
      <v-footer color="primary darken-2">
        <v-layout row wrap align-center>
          <v-flex class="text-center" xs12>
            <div class="white--text ml-4">@2020, TaskForce</div>
          </v-flex>
        </v-layout>
      </v-footer>
    </v-content>
